        ...
        <div className="contact-menu">
            ...
            {!isSent && (
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        ...
                        <input type="text" id="name" name="name" placeholder="Name" value={formData.name} onChange={handleChange} className={errors.name ? "error" : ""} disabled={isLoading} 
                        />
                        {errors.name && (
                    ...
                    <div className="form-group">
                        ...
                        <textarea id="message" name="message" placeholder="Message" value={formData.message} onChange={handleChange} className={errors.message ? "error" : ""} disabled={isLoading} 
                        ></textarea>
                        {errors.message && (
            ...
            {isSent && (
                <div className="success-message">
                    <p>SUCCESS!</p>
                    <p>Your message had been successfully sent!</p>
